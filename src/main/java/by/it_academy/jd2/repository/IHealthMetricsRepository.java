...
public interface IHealthMetricsRepository extends JpaRepository<HealthMetrics, Long> {
    ...
    @Query(value = "SELECT to_char(timestamp, 'YYYY-MM-DD\"T\"HH24:MI:SS'), metric_type, metric_value\n" +
            "FROM polyclinic.user_health_metrics\n" +
    ...
    List<HealthMetrics> findHealthMetricsByMetricTypeAndAndMedicalCardIdOrderByTimestampAsc(HealthMetricsTypes metricType, Long medicalcardId);
